...
class SessionPage(QWidget):
    ...
    def _complete_and_log_session(self, status="Completed"):
        ...
        start_time = self.active_session_data["start_time"]
        prep_sec = self.active_session_data["prep_duration_sec"]
        planned_sec = self.active_session_data["planned_duration_sec"]
        ...
        session_record = {
            ...
            "task_name": self.active_session_data['task_name'],
            "task_details": self.active_session_data['task_details'] or 'None',
            "goal": self.active_session_data.get('goal', 'None'),
            "thought": self.active_session_data.get('thought', 'None'),
            "distraction": self.active_session_data.get('distraction', 'None'),
            "prep_time": prep_str,
